...
<template>
  <div
    v-if="!useUser().user"
    class="flex h-screen w-full justify-center items-center bg-gray-300"
  >
    <div
    ...
    >
      ...
      <div class="p-6 pt-0">
        ...
        >
          ...
          <a
            @click="goRegister()"
            class="ml-1 block font-sans text-sm font-bold leading-normal text-cyan-500 antialiased cursor-pointer"
          >
            register
          </a>
        </p>
